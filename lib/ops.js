...
exports.defaults = defaults.load
exports.tee = tee.tee
exports.unTee = tee.unTee
exports.logrequest = logrequest
exports.getOpts = defaults.getOpts
exports.loadDefaultFile = defaults.loadDefaultFile
exports.getHomeFolder = defaults.getHomeFolder
exports.getTmpFolder = defaults.getTmpFolder
exports.init = init.init
exports.errorstack = errorstack.errorstack
...
function opsconstructor(logger, opts, mockupRequest) {
	...
	function pinger(optsArg) {
		...
		// parse arguments
		var opts = defaults.getOpts(optsArg, {}, [ 'title', 'url'])
